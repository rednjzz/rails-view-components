...
# docker build -t rails_view_components .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name rails_view_components rails_view_components
